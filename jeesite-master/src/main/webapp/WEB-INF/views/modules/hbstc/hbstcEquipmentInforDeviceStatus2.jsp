...
<ul class="nav nav-tabs">
  <li class="active"><a href="${ctx}/hbstc/hbstcEquipmentInfor/deviceStatus2">设备信息列表</a></li>
...
<form:form id="searchForm" modelAttribute="hbstcEquipmentInfor" action="${ctx}/hbstc/hbstcEquipmentInfor/deviceStatus2?deviceStatus=2/" method="post" class="breadcrumb form-search">
...
<ul class="nav nav-tabs">
  ...
  <%--<shiro:hasPermission name="hbstc:hbstcEquipmentInfor:edit"><li><a href="${ctx}/hbstc/hbstcEquipmentInfor/form">设备信息添加</a></li></shiro:hasPermission>--%>
  <li><a href="${ctx}/hbstc/hbstcEquipmentInfor/deviceStatus1">借出设备列表</a></li>
  <li  class="active"><a href="${ctx}/hbstc/hbstcEquipmentInfor/deviceStatus2">外借设备列表</a></li>
</ul>
    ...
    <tr>
      ...
      <shiro:hasPermission name="hbstc:hbstcEquipmentInfor:edit"><td>
        ...
        <a href="${ctx}/hbstc/hbstcEquipmentInfor/delete?id=${hbstcEquipmentInfor.id}" onclick="return confirmx('确认要删除该设备信息吗？', this.href)">删除</a>--%>
          <a href="${ctx}/hbstc/hbstcEquipmentInfor/returnDevice2?id=${hbstcEquipmentInfor.id}" class="btn btn-success" onclick="return confirmx('确认要归还该设备吗？', this.href)">归还设备</a>
